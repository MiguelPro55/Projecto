		...
		<div class="container">
			...
			<form class="form-horizontal" method="POST" action="guardar.php" autocomplete="off">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" id="preciolavado" name="preciolavado" placeholder="preciolavado" required>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" id="precioplanchado" name="precioplanchado" placeholder="precioplanchado">
					</div>
				</div>
