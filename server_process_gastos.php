<?php
	...
	*/
	...
	$aColumnas = array( 'id', 'descripcion', 'monto', 'fecha');
	...
	*/
	...
	while ( $aRow = $rResult->fetch_array())
	{
		...
		$row[] = "<td><a href=''><i class='fas fa-edit'></i></a></td>";
		$row[] = "<td><a href='#' data-href='eliminar_gasto.php?id=".$aRow['id']."' data-toggle='modal' data-target='#confirm-delete'><i class='fas fa-trash-alt'></i></a></td>";
