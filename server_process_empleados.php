<?php
	...
	*/
	...
	$aColumnas = array( 'id', 'usuario', 'clave', 'NuevoPedido','PedidosPendientes','PedidosEntregados','Productos', 'Empleados','ReportePedidos','GanchosVendidos' );
	...
	*/
	...
	while ( $aRow = $rResult->fetch_array())
	{
		...
		$row[] = "<td><a href='modificar_empleados.php?id=".$aRow['id']."'><i class='fas fa-edit'></i></a></td>";
		$row[] = "<td><a href='#' data-href='eliminar_empleados.php?id=".$aRow['id']."' data-toggle='modal' data-target='#confirm-delete'><i class='fas fa-trash-alt'></i></a></td>";
