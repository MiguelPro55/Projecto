<?php
	...
	*/
	...
	$aColumnas = array( 'idpedido', 'Cliente', 'ganchoscliente', 'ganchosvendidos', 'total', 'Abono', 'pendientepagar', 'Empleado', 'horapedido' );
	
	/* columna indexada */
	$sIndexColumn = "idpedido";
	...
	*/
	...
	while ( $aRow = $rResult->fetch_array())
	{
		...
		$row[] = "<td><a href='#' data-href='ajax/productos_pendientes.php?id=".$aRow['idpedido']."' data-toggle='modal' data-target='#detalles'>Prendas</a></td>";
		$row[] = "<td><a>Hola</a></td>";
		#$row[] = "<td><a>Hola2</a></td>";
